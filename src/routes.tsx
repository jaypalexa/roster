...
const routes = () => (
  <Switch>
    ...
    <ProtectedRoute
      exact
      path="/sea-turtle-morphometrics"
      component={SeaTurtleMorphometrics}
    />
    <ProtectedRoute
      exact
      path="/sea-turtle-morphometrics-graphs"
      component={SeaTurtleMorphometricsGraphs}
    />
    <ProtectedRoute exact path="/holding-tanks" component={HoldingTanks} />
    <ProtectedRoute
      exact
      path="/holding-tank-measurements"
      component={HoldingTankMeasurements}
    />
    <ProtectedRoute
      exact
      path="/holding-tank-graphs"
      component={HoldingTankGraphs}
    />
    <ProtectedRoute
      exact
      path="/hatchlings-events"
      component={HatchlingsEvents}
    />
    <ProtectedRoute
      exact
      path="/washbacks-events"
      component={WashbacksEvents}
    />
    <ProtectedRoute exact path="/reports" component={Reports} />
    <ProtectedRoute
      exact
      path="/report-options/:reportId"
