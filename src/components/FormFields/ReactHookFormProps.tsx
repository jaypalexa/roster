import { DeepPartial, ElementLike, FieldName, FieldValue, FieldValues, ValidationOptions } from 'react-hook-form';
...
type ReactHookFormProps<FormValues extends FieldValues = FieldValues> = {
  register<Element extends ElementLike = ElementLike>(validationOptions: ValidationOptions): (ref: Element | null) => void;
  errors?: any; //FieldErrors<FormValues>;
  watch?(fieldNames?: FieldName<FormValues> | FieldName<FormValues>[] | {
      nest: boolean;
  }, defaultValue?: string | DeepPartial<FormValues>): FieldValue<FormValues> | DeepPartial<FormValues> | string | undefined;
}

export default ReactHookFormProps;
