...
const TurtleInjuryReport: React.FC<TurtleInjuryReportProps> = ({currentReportListItem, reportOptions, setShowSpinner}) => {
  const [reportContents, setReportContents] = useState<JSX.Element>(<></>);
  ...
  useMount(() => {
    const buildReport = async () => {
      try {
        ...
        const contents = <div id='turtleInjuryReport'>
...
export default TurtleInjuryReport;
