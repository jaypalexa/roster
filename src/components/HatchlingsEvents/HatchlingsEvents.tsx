  ...
  const tableColumns = [
    {
      ...
      cell: (row: HatchlingsEventModel) => <span className='icon cursor-pointer' onClick={(event) => { onEditHatchlingsEventClick(row, event) }}><i className='fa fa-pencil fa-lg'></i></span>,
    },
    {
      name: '',
      ignoreRowClick: true,
      maxWidth: '2rem',
      minWidth: '2rem',
      cell: (row: HatchlingsEventModel) => <span className='icon cursor-pointer' onClick={(event) => { onDeleteHatchlingsEventClick(row, event) }}><i className='fa fa-trash fa-lg'></i></span>,
    },
    {
      name: 'Species',
      selector: 'species',
