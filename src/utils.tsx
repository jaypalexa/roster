...
export const isSafari = !!navigator.userAgent.match(
  /Version\/[\\d\\.]+.*Safari/
);
...
export const getDefaultDateRange = (
  ...
  return {
    dateFrom: convertDateToYyyyMmDdString(dateFrom),
    dateThru: convertDateToYyyyMmDdString(dateThru),
  } as ReportOptionsDateRangeDto;
};
